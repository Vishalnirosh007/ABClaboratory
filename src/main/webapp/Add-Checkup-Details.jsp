...
<head>
    ...
    <title>Add Checkup Details</title>
</head>
<body>
<div class="container-fluid">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link" href="CheckupDashboard.jsp">Store</a>
        </li>
        <li class="nav-item">
    ...
    <br/>
    <div class="container">
        <h3>Register Checkup Details</h3>
        <br/>
        <p>${message}</p>
        <br/>
        <form method="post" action="checkupController">
            ...
            <textarea class="form-control" id="checkupDescription" name="checkupDescription" rows="3"></textarea>
