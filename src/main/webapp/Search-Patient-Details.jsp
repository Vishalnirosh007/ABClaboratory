    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <form method="post" action="patientController">
                ...
                <input type="number" class="form-control" id="patientPhoneNumber" name="patientPhoneNumber"  value="${not empty patient ? patient.patientPhoneNumber : ''}"/>
                <br/>
                ...
                <input type="email" class="form-control" id="patientEmail" name="patientEmail"  value="${not empty patient ? patient.patientEmail : ''}"/>
                <br/>
                ...
                <input type="password" class="form-control" id="patientPassword" name="patientPassword"  value="${not empty patient ? patient.patientPassword : ''}"/>
